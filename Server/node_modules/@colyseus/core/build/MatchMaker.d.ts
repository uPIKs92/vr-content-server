 ...
 */
export declare function create(roomName: string, clientOptions?: ClientOptions): Promise<SeatReservation>;
/**
 ...
 */
export declare function joinById(roomId: string, clientOptions?: ClientOptions): Promise<SeatReservation>;
/**
